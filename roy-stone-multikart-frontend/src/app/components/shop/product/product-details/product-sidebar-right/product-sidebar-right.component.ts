...
@Component({
  selector: 'app-product-sidebar-right',
  standalone: true,
  ...
  templateUrl: './product-sidebar-right.component.html',
  styleUrl: './product-sidebar-right.component.scss'
})
export class ProductSidebarRightComponent {
