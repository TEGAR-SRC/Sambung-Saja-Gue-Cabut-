...
@Component({
  ...
  templateUrl: './product-thumbnail-outside-images.component.html',
  styleUrl: './product-thumbnail-outside-images.component.scss'
})
export class ProductThumbnailOutsideImagesComponent {
