...
@Component({
  ...
  imports: [CommonModule,
            Fashion1Component, Fashion2Component, Fashion3Component,
            Fashion4Component, Fashion5Component, Fashion6Component,
            Fashion7Component, Furniture1Component, Furniture2Component,
            FurnitureDarkComponent, Electronic1Component, Electronic2Component,
            Electronic3Component, Marketplace1Component, Marketplace2Component,
            Marketplace3Component, Marketplace4Component, Vegetables1Component,
            Vegetables2Component, Vegetables3Component, Vegetables4Component,Jewellery1Component,
            Jewellery2Component, Jewellery3Component, BagComponent, MedicalComponent,
            PerfumeComponent, YogaComponent, BicycleComponent, MarijuanaComponent,
            Jewellery2Component, Jewellery3Component, BagComponent,
            WatchComponent,MedicalComponent, PerfumeComponent,
            ChristmasComponent,BicycleComponent, MarijuanaComponent,
            ToolsComponent, ShoesComponent, KidsComponent,
            BeautyComponent, SurfboardComponent, GogglesComponent,
            GameComponent, FlowerComponent, BooksComponent,
            GymComponent, VideoSliderComponent,
            PetsComponent, NurseryComponent, GradientComponent,
            VideoComponent, FullPageComponent, ParallaxComponent, DigitalDownloadComponent, SingleProductComponent],
