...
import { GetCategories, GetCategory } from '../shared/store/action/category.action';
...
@Component({
  selector: 'app-layout',
  standalone: true,
  imports: [CommonModule, RouterModule,LoadingBarRouterModule ,
            HeaderComponent, FooterComponent, ThemeCustomizerComponent,
            BackToTopComponent, LoaderComponent, NewsletterModalComponent,
            ExitModalComponent, SaleModalComponent, LoginModalComponent,
           RecentPurchasePopupComponent, StickyCompareComponent],
...
export class LayoutComponent {
  ...
  @ViewChild("saleModal") SaleModal: SaleModalComponent;
        ...
        if(event instanceof NavigationEnd ) {
          if(this.theme){
            ...
            if(this.theme == 'fashion_one' ||
              ...
              themeOptionService.theme_color = '#FF5141';
            }
              ...
              themeOptionService.theme_color = '#479FB3';
            }
  ...
  setLogo(){
    ...
    if(this.theme){
      if(this.theme == 'fashion_one' || this.theme == 'tools' || this.theme == 'left_sidebar' || this.theme == 'video'){
        ...
        headerLogo = "assets/images/icon/logo/49.png";
        footerLogo = "assets/images/icon/logo/49.png";
      }
      else if(this.theme == 'fashion_three'){
        ...
        headerLogo = "assets/images/icon/logo/50.png";
        footerLogo = "assets/images/icon/logo/50.png";
      }
