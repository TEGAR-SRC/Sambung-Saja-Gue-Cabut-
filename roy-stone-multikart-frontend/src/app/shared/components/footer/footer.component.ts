        ...
        this.themeOption$.subscribe(option => {
          ...
          if(this.path){
            if(this.path == 'fashion_three' ||
              ...
              StoreJson.footer['bg_image'] = '/storage/3872/digital.jpg'
              this.type = 'footer_four';
            }else if (this.path == 'christmas') {
              StoreJson.footer['bg_image'] = '/storage/3865/christmas.jpg'
              this.type = 'footer_four';
            }else if(this.path == 'tools'){
              StoreJson.footer['bg_image'] = '/storage/3874/tools.jpg'
              this.type = 'footer_four';
            }else if(this.path == 'gym'){
              StoreJson.footer['bg_image'] = '/storage/3873/gym.jpg'
              this.type = 'footer_four';
            }
