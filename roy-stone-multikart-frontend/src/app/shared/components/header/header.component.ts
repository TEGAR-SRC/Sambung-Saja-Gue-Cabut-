...
@Component({
  selector: 'app-header',
  standalone: true,
  imports: [CommonModule, HeaderOneComponent, HeaderTwoComponent,
            HeaderThreeComponent, HeaderFourComponent, HeaderFiveComponent,
            HeaderSixComponent, HeaderSevenComponent, MobileMenuComponent,
  ...
  setHeader() {
    if(this.path){
      ...
      this.themeOption$.subscribe(theme => {
        ...
        console.log("🚀 ~ HeaderComponent ~ setHeader ~ this.sticky:", this.sticky)
      });
    }
  }
}
